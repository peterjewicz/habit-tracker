...
var o__22379__auto___25567 = (function (){var o__22379__auto__ = (function (){var o__22379__auto__ = Promise;
return (o__22379__auto__["resolve"]).call(o__22379__auto__);
})();
return (o__22379__auto__["then"]).call(o__22379__auto__,callback);
})();
(o__22379__auto___25567["catch"]).call(o__22379__auto___25567,devtools.async.rethrow_outside_promise);
...
var G__25568_25569 = Error;
var target__22384__auto___25570 = G__25568_25569;
if(cljs.core.truth_(target__22384__auto___25570)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["unable to locate object path ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(null)," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__25568_25569)].join('')),"\n","target__22384__auto__"].join('')));
}

(target__22384__auto___25570["stackTraceLimit"] = Infinity);
...
//# sourceMappingURL=async.js.map?rel=1542636588392
