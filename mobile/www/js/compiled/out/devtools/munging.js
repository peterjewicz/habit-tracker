...
var o23267 = temp__5455__auto__;
var temp__5455__auto____$1 = (o23267["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o23268 = temp__5455__auto____$1;
return (o23268["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__22379__auto__ = f;
return (o__22379__auto__["toString"]).call(o__22379__auto__);
} else {
return "";
}
}catch (e23269){var _ = e23269;
return "";
}});
...
try{var o__22379__auto___23271 = t;
(o__22379__auto___23271["cljs$lang$ctorPrWriter"]).call(o__22379__auto___23271,t,writer);
}catch (e23270){var __23272 = e23270;
}
...
var char_code = (function (){var o__22379__auto__ = (new String(char$));
return (o__22379__auto__["charCodeAt"]).call(o__22379__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22379__auto__ = String;
return (o__22379__auto__["fromCharCode"]).call(o__22379__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__23273 = num_code;
switch (G__23273) {
case (1):
return (185);
...
var o__22379__auto__ = String;
return (o__22379__auto__["fromCharCode"]).call(o__22379__auto__,superscript_code);
});
/**
...
}catch (e23275){var _e__22386__auto__ = e23275;
return false;
}})())){
...
var vec__23276 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__23276,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o23279 = temp__5455__auto__;
var temp__5455__auto____$1 = (o23279["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o23280 = temp__5455__auto____$1;
return (o23280["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__23283){
var vec__23284 = p__23283;
var ns_detector = cljs.core.nth.call(null,vec__23284,(0),null);
...
var G__23290 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__23291 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__23290;
remaining_tokens = G__23291;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq23281){
var G__23282 = cljs.core.first.call(null,seq23281);
var seq23281__$1 = cljs.core.next.call(null,seq23281);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23282,seq23281__$1);
});
...
var vec__23295 = cljs.core.split_with.call(null,(function (p1__23294_SHARP_){
return cljs.core.not_EQ_.call(null,p1__23294_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__23295,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__23295,(1),null);
...
var vec__23298 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__23298,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__23298,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__23301 = cljs.core.rest.call(null,remaining_tokens);
var G__23302 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__23301;
name_tokens = G__23302;
continue;
} else {
...
var vec__23305 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__23305,(0),null);
var arity = cljs.core.nth.call(null,vec__23305,(1),null);
var vec__23308 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__23308,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__23308,(1),null);
var vec__23311 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__23311,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__23311,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__23311,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__23311,(3),null);
...
var vec__23317 = result;
var munged_ns = cljs.core.nth.call(null,vec__23317,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__23317,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__23317,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__23317,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__23317,(4),null);
var arity = cljs.core.nth.call(null,vec__23317,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__23321 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__23321,(0),null);
var args = cljs.core.nth.call(null,vec__23321,(1),null);
var vec__23324 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__23324,(0),null);
var name = cljs.core.nth.call(null,vec__23324,(1),null);
...
var G__23327 = (arity + (1));
var G__23328 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__23329){
var vec__23330 = p__23329;
var arity = cljs.core.nth.call(null,vec__23330,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__23330,(1),null);
...
return cljs.core.get.call(null,arities,p1__23333_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__23334_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__23337){
var vec__23338 = p__23337;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__23338,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq23335){
var G__23336 = cljs.core.first.call(null,seq23335);
var seq23335__$1 = cljs.core.next.call(null,seq23335);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23336,seq23335__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__23346__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__23346__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__23346__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__23346__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__23347 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__23347,(0),null);
var fn_name = cljs.core.nth.call(null,vec__23347,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__23347,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__23347,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__23347,(4),null);
var arity = cljs.core.nth.call(null,vec__23347,(5),null);
...
var o__22379__auto__ = f;
return (o__22379__auto__["getBasis"]).call(o__22379__auto__);
});
/**
...
}catch (e23351){var _e__22386__auto__ = e23351;
...
var G__23352 = (obj[cljs.core.first.call(null,path)]);
var G__23353 = cljs.core.rest.call(null,path);
obj = G__23352;
path = G__23353;
continue;
} else {
...
return (function (accum,p__23354){
var vec__23355 = p__23354;
var bit = cljs.core.nth.call(null,vec__23355,(0),null);
var protocol = cljs.core.nth.call(null,vec__23355,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__23358){
...
var selector = cljs.core.nth.call(null,vec__23359,(2),null);
...
var matches__$1 = cljs.core.nth.call(null,vec__23364,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__23364,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__23362_SHARP_){
return (obj[cljs.core.first.call(null,p1__23362_SHARP_)]);
});})(name,sorted_matches,vec__23364,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1542636582626
