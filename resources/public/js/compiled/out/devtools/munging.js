...
var o31860 = temp__5455__auto__;
var temp__5455__auto____$1 = (o31860["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o31861 = temp__5455__auto____$1;
return (o31861["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__30972__auto__ = f;
return (o__30972__auto__["toString"]).call(o__30972__auto__);
} else {
return "";
}
}catch (e31862){var _ = e31862;
return "";
}});
...
try{var o__30972__auto___31864 = t;
(o__30972__auto___31864["cljs$lang$ctorPrWriter"]).call(o__30972__auto___31864,t,writer);
}catch (e31863){var __31865 = e31863;
}
...
var char_code = (function (){var o__30972__auto__ = (new String(char$));
return (o__30972__auto__["charCodeAt"]).call(o__30972__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__30972__auto__ = String;
return (o__30972__auto__["fromCharCode"]).call(o__30972__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__31866 = num_code;
switch (G__31866) {
case (1):
return (185);
...
var o__30972__auto__ = String;
return (o__30972__auto__["fromCharCode"]).call(o__30972__auto__,superscript_code);
});
/**
...
}catch (e31868){var _e__30979__auto__ = e31868;
return false;
}})())){
...
var vec__31869 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__31869,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o31872 = temp__5455__auto__;
var temp__5455__auto____$1 = (o31872["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o31873 = temp__5455__auto____$1;
return (o31873["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4499__auto___31880 = arguments.length;
var i__4500__auto___31881 = (0);
while(true){
if((i__4500__auto___31881 < len__4499__auto___31880)){
args__4502__auto__.push((arguments[i__4500__auto___31881]));

var G__31882 = (i__4500__auto___31881 + (1));
i__4500__auto___31881 = G__31882;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__31876){
var vec__31877 = p__31876;
var ns_detector = cljs.core.nth.call(null,vec__31877,(0),null);
...
var G__31883 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__31884 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__31883;
remaining_tokens = G__31884;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq31874){
var G__31875 = cljs.core.first.call(null,seq31874);
var seq31874__$1 = cljs.core.next.call(null,seq31874);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31875,seq31874__$1);
});
...
var vec__31888 = cljs.core.split_with.call(null,(function (p1__31887_SHARP_){
return cljs.core.not_EQ_.call(null,p1__31887_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__31888,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__31888,(1),null);
...
var vec__31891 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__31891,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__31891,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__31894 = cljs.core.rest.call(null,remaining_tokens);
var G__31895 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__31894;
name_tokens = G__31895;
continue;
} else {
...
var vec__31898 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__31898,(0),null);
var arity = cljs.core.nth.call(null,vec__31898,(1),null);
var vec__31901 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__31901,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__31901,(1),null);
var vec__31904 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__31904,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__31904,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__31904,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__31904,(3),null);
...
var vec__31910 = result;
var munged_ns = cljs.core.nth.call(null,vec__31910,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__31910,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__31910,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__31910,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__31910,(4),null);
var arity = cljs.core.nth.call(null,vec__31910,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__31914 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__31914,(0),null);
var args = cljs.core.nth.call(null,vec__31914,(1),null);
var vec__31917 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__31917,(0),null);
var name = cljs.core.nth.call(null,vec__31917,(1),null);
...
var G__31920 = (arity + (1));
var G__31921 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__31922){
var vec__31923 = p__31922;
var arity = cljs.core.nth.call(null,vec__31923,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__31923,(1),null);
...
return cljs.core.get.call(null,arities,p1__31926_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__31927_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__31930){
var vec__31931 = p__31930;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__31931,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq31928){
var G__31929 = cljs.core.first.call(null,seq31928);
var seq31928__$1 = cljs.core.next.call(null,seq31928);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31929,seq31928__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__31939__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__31939__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__31939__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__31939__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__31940 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__31940,(0),null);
var fn_name = cljs.core.nth.call(null,vec__31940,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__31940,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__31940,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__31940,(4),null);
var arity = cljs.core.nth.call(null,vec__31940,(5),null);
...
var o__30972__auto__ = f;
return (o__30972__auto__["getBasis"]).call(o__30972__auto__);
});
/**
...
}catch (e31944){var _e__30979__auto__ = e31944;
...
var G__31945 = (obj[cljs.core.first.call(null,path)]);
var G__31946 = cljs.core.rest.call(null,path);
obj = G__31945;
path = G__31946;
continue;
} else {
...
return (function (accum,p__31947){
var vec__31948 = p__31947;
var bit = cljs.core.nth.call(null,vec__31948,(0),null);
var protocol = cljs.core.nth.call(null,vec__31948,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__31951){
var vec__31952 = p__31951;
var ns = cljs.core.nth.call(null,vec__31952,(0),null);
var name = cljs.core.nth.call(null,vec__31952,(1),null);
var selector = cljs.core.nth.call(null,vec__31952,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__31957,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__31957,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__31957,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__31955_SHARP_){
return (obj[cljs.core.first.call(null,p1__31955_SHARP_)]);
});})(name,sorted_matches,vec__31957,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1557923590798
