...
}catch (e25573){var _e = e25573;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___25576 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___25576)){
var seen_errors_25577 = temp__5455__auto___25576;
if(cljs.core.truth_(seen_errors_25577.has(self))){
} else {
seen_errors_25577.add(self);

var temp__5457__auto___25578 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___25578)){
var sense_25579 = temp__5457__auto___25578;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_25579)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1542151517248
