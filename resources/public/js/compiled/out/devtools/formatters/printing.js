...
var len__4499__auto___31991 = arguments.length;
var i__4500__auto___31992 = (0);
while(true){
if((i__4500__auto___31992 < len__4499__auto___31991)){
args__4502__auto__.push((arguments[i__4500__auto___31992]));

var G__31993 = (i__4500__auto___31992 + (1));
i__4500__auto___31992 = G__31993;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq31988){
...
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31989,G__31990,seq31988__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__31994_SHARP_){
return !((cljs.core.meta.call(null,p1__31994_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__31995__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e31999){var _e__30979__auto__ = e31999;
return false;
}})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
}catch (e32001){var _e__30979__auto__ = e32001;
return false;
}}
})())){
...
var _STAR_current_state_STAR_32003 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__32004 = opts;
...
var markup_db = cljs.core.get.call(null,map__32004__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_32003;
}});
...
;
var temp__5455__auto___32008 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___32008)){
var managed_print_level_32009 = temp__5455__auto___32008;
var _STAR_print_level_STAR_32007_32010 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_32009;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_32007_32010,managed_print_level_32009,temp__5455__auto___32008,writer,opts,job_fn){
return (function (p1__32006_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__32006_SHARP_,null);
});})(_STAR_print_level_STAR_32007_32010,managed_print_level_32009,temp__5455__auto___32008,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_32007_32010;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1557923591200
