...
return (new CustomEvent(event_name,(function (){var obj29004 = {"detail":data};
return obj29004;
})()));
} else {
...
var f = (function (){var pred__29011 = cljs.core._EQ_;
var expr__29012 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__29011.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__29012))){
return ((function (pred__29011,expr__29012){
return (function (p1__29005_SHARP_){
return console.warn(p1__29005_SHARP_);
});
;})(pred__29011,expr__29012))
} else {
if(cljs.core.truth_(pred__29011.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__29012))){
return ((function (pred__29011,expr__29012){
return (function (p1__29006_SHARP_){
return console.debug(p1__29006_SHARP_);
});
;})(pred__29011,expr__29012))
} else {
if(cljs.core.truth_(pred__29011.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__29012))){
return ((function (pred__29011,expr__29012){
return (function (p1__29007_SHARP_){
return console.error(p1__29007_SHARP_);
});
;})(pred__29011,expr__29012))
} else {
return ((function (pred__29011,expr__29012){
return (function (p1__29008_SHARP_){
return console.log(p1__29008_SHARP_);
});
;})(pred__29011,expr__29012))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__29015){
...
var eval_fn = cljs.core.get.call(null,map__29016__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__29018_SHARP_);
});})(new_def))
);
...
return (function (p__29019){
var vec__29020 = p__29019;
var ky = cljs.core.nth.call(null,vec__29020,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1542151519603
