...
var currentStorage_27597 = cljs.core.js__GT_clj.call(null,JSON.parse(window.localStorage.getItem("habits")));
if(cljs.core.not.call(null,cljs.core.some.call(null,cljs.core.PersistentHashSet.createAsIfByAssoc([cljs.core.deref.call(null,habit_tracker.components.New.new_habit_name)]),currentStorage_27597))){
window.localStorage.setItem("habits",JSON.stringify(cljs.core.clj__GT_js.call(null,cljs.core.conj.call(null,currentStorage_27597,cljs.core.deref.call(null,habit_tracker.components.New.new_habit_name)))));
...
})], null),"X"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h3.title","h3.title",1837656649),"New Habit"], null)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.New--content","div.New--content",-1292506787),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),"Add a new habit to track below"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref.call(null,habit_tracker.components.New.new_habit_name),new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),"Habit Name",new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__27598_SHARP_){
return cljs.core.reset_BANG_.call(null,habit_tracker.components.New.new_habit_name,p1__27598_SHARP_.target.value);
...
//# sourceMappingURL=New.js.map?rel=1542722088126
