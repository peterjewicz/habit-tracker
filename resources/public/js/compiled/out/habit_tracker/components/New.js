...
var currentStorage_22330 = cljs.core.js__GT_clj.call(null,JSON.parse(window.localStorage.getItem("habits")));
if(cljs.core.not.call(null,cljs.core.some.call(null,cljs.core.PersistentHashSet.createAsIfByAssoc([cljs.core.deref.call(null,habit_tracker.components.New.new_habit_name)]),currentStorage_22330))){
window.localStorage.setItem("habits",JSON.stringify(cljs.core.clj__GT_js.call(null,cljs.core.conj.call(null,currentStorage_22330,cljs.core.deref.call(null,habit_tracker.components.New.new_habit_name)))));
} else {
...
habit_tracker.components.New.render = (function habit_tracker$components$New$render(){
return new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.New","div.New",1346884937),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.Header","div.Header",-753829133),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h2.title","h2.title",866247517),"New Habit"], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p.close","p.close",-1878443002),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
...
return habit_tracker.utils.view_handler.home_view_active.call(null);
})], null),"Back to Dashboard"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref.call(null,habit_tracker.components.New.new_habit_name),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__22331_SHARP_){
return cljs.core.reset_BANG_.call(null,habit_tracker.components.New.new_habit_name,p1__22331_SHARP_.target.value);
...
//# sourceMappingURL=New.js.map?rel=1542151511033
